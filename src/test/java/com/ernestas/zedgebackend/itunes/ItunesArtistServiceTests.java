...
public class ItunesArtistServiceTests extends ITBase {
  ...
  public void getAlbumsOk() {
    ...
    Mockito.when(itunesGateway.getAlbumsByArtistId(1L))
        .thenReturn(List.of(
            Album.builder().collectionId(1L).build(),
            Album.builder().collectionId(2L).build()
        ));
  ...
  public void saveArtistOk() {
    ...
    Artist expected = Artist.builder()
        .artistName("Kendrick")
        .artistId(50L).build();

    Artist actual = itunesArtistService
        .saveArtist(user.getId(),
            ArtistCreate.builder().artistName("Kendrick").artistId(50L).build());
  ...
  public void searchArtistsOk() {
    ...
    Mockito.when(itunesGateway.searchArtistsByArtistName(Mockito.any())).thenReturn(
        expectedList
    );
  ...
  public void saveArtistWhenArtistAlreadyExistsOk() {
    ...
    Artist savedArtist = artistRepository.saveAndFlush(Artist.builder()
        .artistId(50L)
        .artistName("Kendrick")
        .build());
